...
function CharityProfile({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm flex items-center justify-center p-5">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="charity-profile-title"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-6">
          ...
          {[
            { label: 'Name', name: 'name', type: 'text', placeholder: 'Charity Name' },
            { label: 'Account Number', name: 'accNo', type: 'text', placeholder: 'Account No.' },
